        ...
        <form id="form-danh-sach-bai-thi-lop-hoc-phan" class="p-6 mb-0">
            ...
            <div class="mt-2">
                ...
                <div class="w-full relative">
                    <input type="text" class="w-full h-8 px-4 py-2 border outline-none rounded" id="input-search-bai-thi--lop-hoc-phan">
...
<script type="text/javascript">
    ...
    var inputSearch = document.getElementById('input-search-bai-thi--lop-hoc-phan');
