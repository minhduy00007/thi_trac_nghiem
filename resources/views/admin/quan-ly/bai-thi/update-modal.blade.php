        ...
        <form id="form-cap-nhat-bai-thi">
            <div>
                <div class="form-group grid grid-cols-3 gap-4 mb-2">
                    ...
                    <select id="input-ma-lop-hoc-phan-cap-nhat" class="input-cap-nhat-bai-thi col-span-2 border rounded-sm px-2 py-1">
...
<script type="text/javascript">
    ...
    $('#form-cap-nhat-bai-thi').on('submit', function(event){
      ...
      if (ma_bai_thi && ten_bai_thi) {
        ...
        axios.put(secureUrl("{{ route('admin.quan-ly.bai-thi.handle-cap-nhat-bai-thi') }}"), {
